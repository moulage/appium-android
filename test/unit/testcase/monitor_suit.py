...
class MonitorSuit(unittest.TestCase):
    ...
    def monitor_test(self):
        ...
        #
        # suite.addTests(map(BookOrderActivity, ['test_04_498_060170_TenantBookPage_JumpToWaitToConfirmPage']))
        #
        ...
        #
        # suite.addTests(map(TenantIMDetailActivity, ['test_08_145_080242_ReceiveMsgInBackground',
        #                                             'test_08_137_080216_TenantDetailSendMsg']))
        #
